...
class HomePage(tk.Frame):
    ...
    def search(self):
        ...
        # self.photo_list = []
        self.card_datass = self.getData.search(
    ...
    def showPhoto(self, card):
        ...
        uberschreift = tk.Label(textFrame, text="Hersteller: deutschland")
        ...
        for card in card_data:
            ...
            photo = ImageTk.PhotoImage(img)
            self.photo_list.append(photo)  # Store PhotoImage object in the list
            self.create_card_ZB(card, fahrzugeTeile)
